...
const DATA_URL_PREFIX = module.uri.replace(/lib\/subprocess\.js/, "data/");
const WORKER_URL_WIN = DATA_URL_PREFIX + "subprocess_worker_win.js";
const WORKER_URL_UNIX = DATA_URL_PREFIX + "subprocess_worker_unix.js";
